<template>
  <div class="app wallpaper">
    <div class="installer-box">
      ...
      <p class="description">Téléchargez et installez la dernière version de Minecraft en un seul clic.</p>

      <button class="download-btn" @click="startDownload" :disabled="isDownloading || isComplete">
        <span v-if="isComplete">✅ Téléchargé</span>
        <span v-else-if="isDownloading">⬇️ Téléchargment en cours...</span>
        <span v-else>⬇️ Télécharger</span>
      </button>
      ...
      <div v-if="isComplete" class="complete-message">
        🎉 Votre installeur Minecraft a été téléchargé avec succès !
      </div>
    </div>
  </div>
</template>
