<template>
  <div class="p-4 flex flex-col gap-4" :class="colorShiftEnabled ? 'color-shift' : 'overflow-hidden'">
    ...
    <DesktopWindow name="Messagerie" :lastClickedWindow="currentlyOpenWindows.lastClickedWindow"
      :currentlyOpenWindows="currentlyOpenWindows.openWindows" @clickInsideWindow="setLastClickedWindow"
      @close="closeWindow">
      <AppsMail />
    </DesktopWindow>
    <DesktopWindow name="Navigateur" :lastClickedWindow="currentlyOpenWindows.lastClickedWindow"
      :currentlyOpenWindows="currentlyOpenWindows.openWindows" @clickInsideWindow="setLastClickedWindow"
      @close="closeWindow">
    ...
    <DesktopWindow name="Bloc-notes" :lastClickedWindow="currentlyOpenWindows.lastClickedWindow"
      :currentlyOpenWindows="currentlyOpenWindows.openWindows" @clickInsideWindow="setLastClickedWindow"
      @close="closeWindow">
      <AppsNotepad />
    </DesktopWindow>
    ...
    <div id="row-1" class="flex flex-row justify-between items-center gap-4 w-full">
      ...
      <div class="flex flex-row gap-17 items-center ml-5">
        <DesktopIcon windowName="Messagerie" @openWindow="(windowName) => openWindow(windowName)"
          class="flex flex-col items-center min-w-[16px]">
          <img src="/icons/email.png" alt="Mail Icon" class="w-14 h-14 mb-1" />
        </DesktopIcon>
        <DesktopIcon windowName="Navigateur" @openWindow="(windowName) => openWindow(windowName)"
          class="flex flex-col items-center min-w-[16px]">
    ...
    <div id="row-2" class="flex flex-row justify-between items-center w-full gap-4 ml-1">
      ...
      <div class="flex flex-row gap-12 items-center">
        ...
        <DesktopIcon windowName="Bloc-notes" @openWindow="(windowName) => openWindow(windowName)"
          class="flex flex-col items-center min-w-[16px] flex-1">
